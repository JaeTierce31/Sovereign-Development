...
export default function ExecutionPanel({ files, activeFile, onClose }: ExecutionPanelProps) {
    ...
    <div className="flex flex-col h-full bg-[#0f1117] border-t border-gray-700">
      <div className="flex items-center gap-2 px-3 py-1.5 border-b border-gray-700 shrink-0 bg-gray-900">
        <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider flex-1">
          Terminal
          {activeFile && (
            <span className="ml-2 font-normal normal-case text-gray-600">— {activeFile.path}</span>
          )}
        </span>
